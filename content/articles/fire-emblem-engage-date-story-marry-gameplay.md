...
This carries over to the game's character design; yes, the game still borrows heavily from the high-fantasy genre, evident by the amount of tomes, lances, and capes present. But when units are paired with special units called "Emblems", these designs veer into uncharted, neon-glowing territories. Some characters sprout futuristic wings, while others are adorned with <a target="_blank" href="/future.jpeg">spinning propulsion systems</a>. As to *how* these futuristic aesthetics make sense in the *Fire Emblem* universe, I'm not really sure. But if I'm being honest, I'd call it a welcome change-up from a style that the series has gotten, perhaps, too comfortable with.

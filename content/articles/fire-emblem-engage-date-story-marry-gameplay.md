...
Not quite, in my opinion. Never one for broad-brush generalizations, I think that lots of the discourse surrounding this game leaves out a lot of juicy details that people might otherwise be interested in. So, in this review, I'll try to focus on aspects of *Engage* that I think weren't talked about enough, but warrant further discussion.

I've been a fan of the series since Awakening (I can hear "LynLover69" physically cringing), but I've played many *Fire Emblem* titles since then. In order of preference, I've also played *Conquest* and its DLC campaign (3DS), *Echoes: Shadows of Valentia* (3DS, remake of an NES game), and *Sacred Stones* (GBA). I fell in love with the series' unforgiving, calculated gameplay, and *Engage* came out at a time when I wanted more.

I actually skipped *Three Houses* (*Engage's* predecessor) due to its reputation for being bloated with silly JRPG social/dating nonsense (I watched in agony as my wife spent countless hours trying maximize social links between party members). *Engage* had been reported by many reviewers to be a much-welcomed course correction from *Three Houses*, so I was eager to give it a go.
...
Want to temporarily give your healing mage +5 range? Want to spawn giant ice pillar blockades to give your units time to heal? What about an ability that draws enemies in for one turn, culminating in a huge multi-space explosion on the next turn? The Emblem system makes this, and more, possible.
...
This is because the majority of the game's narrative follows a dreadfully-predictable formula based on recruitment: players are linearly shuffled around to the world's various countries in order to recruit units. At each country, the local royal figures are threatened somehow by evil, and it's up to the player to stop them, culminating in some of them joining our cause.
...
But unfortunately, none of these questions are <text-with-tooltip :tooltip="'It\'s possible that the DLC delves into this, but that is not even remotely good enough of an justification for leaving these points out of the main game. A $60 game shouldn\'t require additional purchases in order to make a narrative whole.'">ever answered</text-with-tooltip>, and we're left with *implications* of a larger, more expansive narrative without it ever being delivered. Instead, *Engage* is content with *telling* us about all these supposedly important events that happened 1000's of years ago, foolishly believing that this is enough to get players invested in it's story. Obviously, it's not.

...
* I've never played *Three Houses*, but I watched my wife play through it.
...
While not necessarily inaccurate (I'll get to that in a bit), I don't think that this opinion gives *Engage* the credit it deserves, since I don't think the game is merely a "good enough" *Fire Emblem* game. Instead, I think it does a *lot* of things right (as well as a lot of things wrong) that warrant further discussion.
...
This carries over to the game's character design; yes, the game still borrows heavily from the high-fantasy genre, showcasing lances, capes, cloaks, and lace. But when paired with Emblems, units inherit their neon glows, augmenting their appearances in interesting ways. Some characters sprout futuristic wings, while others are adorned with <a target="_blank" href="/future.jpeg">spinning propulsion systems</a>. As to *how* these cyberpunk influences make sense in the *Fire Emblem* universe, I'm not sure. But if I'm being honest, I'd call it a welcome change-up from a style that the series has gotten, perhaps, too comfortable with.
...
This also serves a functional purpose: a strategy game's experience hinges upon how easy or difficult it is for the player to ascertain answers to questions like "where are my positional weak points?", or "where should I begin my assault?", or "who is going to die next turn unless I intervene?". 

And, while not perfect (I'll get to that in a later section), *Engage* is a definite step in the right direction. Compared to <a target="_blank" href="/3houses.jpeg">its predecessor</a>, which looks like an PS3-era mess of grays and brown, *Engage's* vibrancy greatly improves its visual clarity.

And, as expected from any mainline Nintendo game, *Engage's* music is simply phenomenal (excluding its <text-with-tooltip :tooltip="'Attention anime/videogame composers: instrumental melodies are NOT interchangeable with lyrical melodies! A melody that sounds great when played on a guitar will NOT NECESSARILY sound great when sung!'">terrible opening theme</text-with-tooltip>). I'm not sure how else to the describe it, but it's absolutely criminal that this game's soundtrack didn't win every video game music award on the planet.

On top of that, the game has an excellent sense of aural awareness: it knows when to deploy something soft and sweet (i.e. the link below), and it knows when to ramp up the tempo. Most importantly (and I can't stress this enough), it knows when to get out of the way; most of *Engage's* mid-battle music is catchy, but not obtrusive or attention-grabbing, giving players plenty of mental space to think. Far too often do games (anime games in particular) get carried away with complicated melodies during moments that deserve attention elsewhere, and thankfully, *Engage* is acutely aware of this.
...
That I was able to complete the game the way I wanted to is a testament to how tightly the game is designed. In my opinion, this is partially thanks to the re-introduction (with a subtle twist) of the series' classic <text-with-tooltip :tooltip="'Swords beat axes, axes beat lances, and lances Beat swords. Oh, and mages\' weakness is PUNCHING.'">"weapon triangle"</text-with-tooltip>, which gives each unit a clear role to nestle into. Archers are great for keeping flying enemies at bay, mages obliterate otherwise-formidable armored units, and good ole' fists can be used to punch mages in their stupid, conceited faces.

Rather than simply picking one's highest-level units, the weapon triangle forces players to survey the battlefield before deploying to determine which units might work best for the situation at hand. This has the effect of making battles less about resources and EXP, and more about knowing what tools to use at the right times and in the right positions.

This ties into other reason that *Engage's* gameplay excels: there are *so many* tools at the player's disposal that they can leverage, and this is, in part, thanks to the game's ingenious <text-with-tooltip :tooltip="'When paired with Fire Emblem characters from past games, represented as rings, your units can temporarily boost their stats and abilities, which can be enough to bring back a battle from the brink of defeat.'">"Emblem system"</text-with-tooltip>. There are many, many ways in which players can distribute their emblem rings, with each ring having class-dependent effects on its recipient.

Want to temporarily give your healing mage +5 range? Want to spawn giant ice pillar blockades to give your units time to heal? What about an ability that draws enemies in for one turn, culminating in a huge multi-space explosion on the next turn? The Emblem system makes this, and more, possible since *any* unit can be paired with *any* Emblem.

While initially overwhelming, this system smartly encourages player experimentation and creativity, leading to endless strategic possibilities. For example, one of my favorite moments with *Engage* was when I concocted a hare-brained strategy that hinged upon using <span class="spoiler">Veyle</span> and Micaiah to launch Timerra and Ike half-way across the map, and the payoff when it actually *worked* was incredible. 
...
And if the complexity of this sounds scary to you, then fear not: *Engage* throws a bone to those that are put off by tinkering by suggesting default pairing between units and Emblems, pairings that are plenty strong. For example, Marth is naturally paired with Alear, Timmera is naturally paired with Ike, etc. So, if you'd rather have this process streamlined, *Engage* is willing to help.
...
* I cannot overstate how robotic and stilted the main (male) character's performance is, which is unfortunate because he has, by far, the most lines in the game. His performance is severely over-enunciated, which elicited only a single thought in my head: "human beings don't speak like that". The voice actors that were willing to be looser with their enunciation and breathing (again, like Yunaka and Ivy) sound *far* more natural.

* Support conversations with Emblems (called "Bonds") consist of two characters spouting meaningless rhetoric at each other (i.e. "When facing adversity, hold strong and believe in your friends to turn the tide of battle"). It would have been nice to actually converse with past *Fire Emblem* characters, rather than with motivational posters.

* Map variety is on the thinner side, with about 75% of the missions tasking players to simply defeat all of the opponents units. In addition, while being pretty aggressive with sending in reinforcements <text-with-tooltip :tooltip="'Moving all of your units in one blob at a time, sticking out a single high-defense unit to lure enemies in.'">"Turtling"</text-with-tooltip> is a viable strategy for almost every map (unlike *Conquest*, which would heavily punish you for it).

* Aside from resource management (which I think is fun, but I can easily see how some players might find it monotonous), every single activity at <text-with-tooltip :tooltip="'The game\s hubworld. Players return to it after every battle.'">the Somniel</text-with-tooltip> is a waste of time. The activities and minigames are unfun, take *far* too long, and the rewards are not worth the time spent. For example, I completely ignored the little cat thing since petting it and feeding it forces players into an mandatory 15-second cutscene *every time*. *WHY are they not skippable???*
...
<div class="imageContainer">
  <img :src="'/goldmar.jpg'"/>
  <span class="text--secondary">And for my final question: why are her boobs vacuum-sealed to her dress? Does double-sided sticky tape exist in the Fire Emblem universe?</span>
</div>
...
To figure out what the right-most ability does, I need to select the unit, press X, and the scroll *all the way* to the right. For those counting at home, that is **14** button presses. 
...
Let's play a different game: in the screenshot below, which unit hasn't yet been moved?
...
<span class="spoiler">As your units stand steadfast, the music swells in intensity while the main villain snarls one final vicious, yet despondent, insult, as if your very existence is nothing but a hinderance.</span> Finally, as the battle starts, the game's main theme song cuts through the melodrama to kick the action into high-gear.
...
I think the main problem with *Engage's* story is that it follows a dreadfully-predictable formula based on recruitment: players are linearly shuffled around to the world's various countries in order to recruit units. At each country, the local royal figures are threatened somehow by evil, and it's up to the player to stop them, culminating in some of them joining our cause.

I hate it when <text-with-tooltip :tooltip="'Both Zelda games on the Switch are prime examples of this: nothing of interest happens in either game until all four guardians are recruited.'">games</text-with-tooltip> telegraph this "recruitment" based narrative structure because it makes it *very* clear to the player that absolutely nothing of significance will happen until all X characters/crystals/whatever are collected. In *Engage's* case, as soon as I landed in Firene and saw that there were 3 more countries on the map, I knew exactly how things were going to go. 

And sure enough, I was right. Nothing of importance happens for the first 20 chapters (save for maybe chapter 14). Instead, the player is whisked from location to location, meeting characters that have no impact on the story.

These recruitment stories aren't always a death sentence for player engagement: some games manage to get away with it by giving each recruit their own localized, personal conflicts. Mass effect, for example, handles this by dedicating a *lot* of time to these new characters' smaller conflicts, and then smartly integrates them into the main story in interesting and unexpected ways (i.e. Wrex and the "Genophage" in Mass Effect 2).

...
With a lack of notable RPG releases this year due to the COVID-19 pandemic, my fiance and I decided to tackle some of the games in our backlog.  

As a lifelong [*Tales Of* Series fan](https://en.wikipedia.org/wiki/Tales_(video_game_series)), my fiance had been itching to play **Tales of Symphonia**, an action-oriented JRPG for the Gamecube. Originally published by Bandai Namco in 2004, it's seen several re-releases since then: it was ported to the PS2, then to the PS3, and then finally to PC.
...
But as a cohesive whole, the game is massively flawed. It's tedious, frustrating, and outright disrespectful to the player's time. While there are *many* aspects of the game that I didn't like, I'll narrow it down to one main critique: **a linear experience with no hook.**
...
But for linear game designs to pay off, there needs to be a "hook". Whether that hook is gameplay (i.e. exciting action sequences), story-driven (i.e. cutscenes, major plot events), or something else, the game needs to be able to entice the player to go along with its linear structure. For example, it needs to convince the player that *they* want to search a forest for [The Green Crystal Shard](http://hrwiki.org/wiki/Twenty_THANXty_Six#Trivia), rather than simply tell the player, "you need to go to this forest and search for the crystal. Don't ask me why. You simply have to do it". When linear games fail to compel the player into following along, they tend to start feeling like chores, rather than games.

Despite its fun battle system, *Tales of Symphonia* lacks this hook. Presentation-wise, the game fails for a number of reasons:
* The game's premise is interesting, but its execution is an absolute mess. I won't attempt to summarize the game's story here because that would be impossible. There's simply too much going on: Sacrifice, Betrayal, Genocide, and Legacy are major themes for *Symphonia*, but the game fails to flesh any of these themes out. 
* In order to accommodate all of these narrative threads, the game's forces you to march your party back and forth (and sometimes back again) between towns. I wouldn't even call these "fetch quests" because there's often no battling involved (you can avoid them). Your only reward for this is more story exposition dumps and dialog-heavy cutscenes. My suspicion is that this was done to pad out the game's length so it could claim "40 hours of gameplay" on the back of its box.
* Speaking of that, the game's voice-acted dialog ranges from inoffensive to painful. During cutscenes, characters are either stiffly animated or not at all, and it's common to see a character's smiling face in the background of a serious cutscene. They may as well be [T-Posing](https://en.wikipedia.org/wiki/T-pose).
* The game's script is much too on-the-nose, and is incredibly awkward to hear out loud. Characters *constantly* explain their thoughts, feelings, and motivations (violating the Golden Rule of Storytelling, "Show, don't Tell"), which makes them seem robotic and unnatural. Villains are laughably one-note, with one calling the main cast "Inferior Beings" at every possible opportunity.
...
The game also punctuates the end of each chapter with history lessons for the player about Chopin's real life, with his music accompanying real-life imagery. While it sounds bizarre, it works surprisingly well: these moments were something that my fiance and I looked forward to as we progressed through the game. While it may not seem like it at first glance, these history lessons also have subtle, yet interesting, connections to the game's storyline. Things like this make *Eternal Sonata* a little weird, but refreshingly different and thoroughly *earnest*.
...
Needless to say, this game absolutely *nails* its presentation. And it's refreshing to play a JRPG that doesn't relentlessly drill one-liners and "This is why I must" speeches into the player's ears. While not every second of *Eternal Sonata* is perfect (in particular, some of its monologues are a little too self-indulgent), its art design, sound, and animations are immensely enjoyable. This is important because, like *Symphonia*, *Eternal Sonata* spends a lot of its time in cutscenes.

*Eternal Sonata* is at its best when its free to flex its artistic muscles, but suffers from some of the same gameplay problems that *Symphonia* does. Its dungeon designs, for example, tend to be narrow, linear passages that force the player through enemies that spawn a *little* too often. This is compounded by the fact that, despite being enjoyable at face-value, the game's battles last a *little* too long. Symphonia fared better in this regard because of its real-time nature: there's no downtime when in battle, and makes the player feel engaged and entertained for the battle's entirety. *Eternal Sonata*, on the other hand, forces you to sit through each enemy's turn, which can sometimes lead to waiting periods of over 30 seconds. This isn't a problem when the enemy encounter rate is manageable, but in dungeons, battles will probably start grating on the player's nerves.
...
Also like *Symphonia*, *Eternal Sonata's* dialog is a little wonky. Lines that may have *read* fine in the script sound very stilted and unnatural when spoken out loud by voice actors that sometimes struggle to convey the appropriate tone. Like many other RPGs, this may be due to a sub-par, low-budget localization from Japanese, but regardless of the reason, the game's script could have been improved. 

*Eternal Sonata* is also extremely linear, perhaps even more linear than *Symphonia*. But unlike *Symphonia*, *Eternal Sonata* has a "hook": I was eager to power through dungeons so that I could experience more of the game's presentation: the Chopin history lessons, the game's landscapes and vistas, the entertaining cutscenes and animations, and the wonderful music were significant enough motivators for me to trudge through the game's weaker moments. 

And to be clear, the game's battle system *is* fun: I enjoyed leveling up and unlocking new abilities for each of the game's characters, and I was eager to try them out in battle. In addition, the battle system's mechanics actually change (i.e. get harder but more rewarding) as you progress, which helps keep things fresh. Things only become an issue for play sessions that last over an hour, as the game's battles will start to wear on the player.

But again, the rest of the game was so entertaining that it didn't really matter to me in the end. Unlike *Symphonia*, which I begrudgingly finished and felt very little at the game's conclusion, I felt a *lot* of things by the time I finished *Eternal Sonata*. I felt a sense of relief, gratitude, hope, and even sadness. I don't mean to say that I wish the game was *longer*: it was neither too short not too long. Rather, my point is that the game expertly juxtaposes life, death, love, heartache, nostalgia, and pain with its story to complement the bittersweet tones of Chopin's music. To that end, this game succeeds in chronicling the life of Chopin, the brilliant Polish Composer, as well as Chopin, the young man who lived a tumultuous life and died too early. 
